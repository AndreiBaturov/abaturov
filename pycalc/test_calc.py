#!/usr/bin/env python3
"""
Unit and integration tests for package pycalc
"""
import unittest
import re
...
from pycalc.pkg_calc import (calc, _Token, _modify_expr, _postfix_queue,
                             _pkg_calc, _tokenize_expr, _unary_replace)
